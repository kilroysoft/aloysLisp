 ...
 * 
 */
public class SHORT_FLOAT extends FLOAT implements tSHORT_FLOAT
{
	public short	value;
	 ...
	 * @param init
	 */
	public SHORT_FLOAT(Integer init)
	{
	 ...
	 * @param init
	 */
	public SHORT_FLOAT(Double init)
	{
		value = init.shortValue();
	}
	 ...
	 * @param init
	 */
	public SHORT_FLOAT(tNUMBER init)
	{
