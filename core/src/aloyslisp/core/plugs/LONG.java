 ...
 * 
 */
public class LONG extends PMath<Long> implements tFIXNUM
{
	/**
	 * @param val
	 */
	 ...
	 * @return
	 */
	public static LONG make(Number val)
	{
	...
	{
		return make(a.getValue().longValue() + b.getValue().longValue());
	}
	...
	{
		return make(-a.getValue().longValue());
	}
	...
	{
		return make(a.getValue().longValue() / (Long) b.getValue().longValue());
	}
	...
	{
		return a.getValue().longValue() == b.getValue().longValue();
	}
	...
	{
		return make(Math.abs(a.getValue().longValue()));
	}
	...
	{
		return make(Math
				.max(a.getValue().longValue(), b.getValue().longValue()));
	}
	...
	{
		return make(Math
				.min(a.getValue().longValue(), b.getValue().longValue()));
	}
